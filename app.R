...
### breeding developed by Dr. Roberto Fritsche Neto and Ph.D. students             ###
### Filipe Inacio Matias and Julia Silva Morosini, who integrate the Laboratory    ###
### of Allogamous Plant Breeding group - Department of Genetics, "Luiz de Queiroz" ###
...
# #####################################################################################################################################################################################
      ...
      tabItem("start", box(status = "primary", height = 700, width = 600, align = "center",
                           ...
                           fluidRow(
                             infoBox(hr(), "Home Page",icon=icon("home"), fill = T, color = "light-blue",
                                     href = "http://www.genetica.esalq.usp.br/alogamas/index2.html"),
                             infoBox(hr(), "USP Page",icon=icon("users"), fill = T, color = "light-blue",
                                     href = "http://www.en.esalq.usp.br"),
                             infoBox(hr(), "Twitter Page",icon=icon("twitter"), fill = T, color = "light-blue",
                           ...
                           strong("v.2.0: NEW FEATURES AVAILABLE!"),
                           br(),
              ...
              fluidPage(
                ...
                sidebarLayout(
                  sidebarPanel(
                    ...
                    sliderInput("Lear8.5","Selection Intensity (i)",0,50,0,step = 1),
      ...
      tabItem("Lear81",
              fluidPage(
                ...
                sidebarLayout(
                  ...
                  mainPanel(verbatimTextOutput("cont.Lear.8.1"),
      ...
      tabItem("Lear10",
              fluidPage(
                ...
                sidebarLayout(
                  ...
                  mainPanel(verbatimTextOutput("cont.Lear.10.1"),
            ...
            sidebarPanel(
              ...
              radioButtons('quote1311', 'Quote',
                           c(None='',
                             ...
                             'Single Quote'="'"),
                           ''),
              checkboxInput("info.1311","Help", FALSE),
            ...
            sidebarPanel(
              ...
              radioButtons('quote1321', 'Quote',
                           c(None='',
                             ...
                             'Single Quote'="'"),
                           ''),
              checkboxInput("info.1321","Help", FALSE),
            ...
            sidebarPanel(
              ...
              radioButtons('quote1331', 'Quote',
                           c(None='',
                             ...
                             'Single Quote'="'"),
                           ''),
              checkboxInput("info.1331","Help", FALSE),
        ...
        fluidPage(
          ...
          sidebarLayout(
            sidebarPanel(
              ...
              checkboxInput("info.1312","Help", FALSE)),
        ...
        fluidPage(
          ...
          sidebarLayout(
            sidebarPanel(
              ...
              checkboxInput("info.1322","Help", FALSE)),
        ...
        fluidPage(
          ...
          sidebarLayout(
            sidebarPanel(
              ...
              checkboxInput("info.1332","Help", FALSE)),
            ...
            sidebarPanel(
              ...
              radioButtons('quote15', 'Quote',
                           c(None='',
                             ...
                             'Single Quote'="'"),
                           ''),
              checkboxInput("info.151","Help", FALSE),
          ...
          sidebarLayout(
            sidebarPanel(
             ...
             numericInput("res.15.3","Minimum Value of Correlation",min = c(-1),max = 1,value = 0.1,step = 0.01),
              ...
              checkboxInput("info.152","Help", FALSE)),
        ...
        fluidPage(
          ...
          sidebarLayout(
            sidebarPanel(
              ...
              checkboxInput("info.18","Help", FALSE)),
            ...
            sidebarPanel(
              ...
              radioButtons('quotemol61', 'Quote',
                           c(None='',
                             ...
                             'Single Quote'="'"),
                           ''),
              checkboxInput("info.mol61","Help", FALSE),
...
# #####################################################################################################################################################################################      
      ...
      tabItem("info1",         
              fluidPage(
                ...
                br(),
# "Be-Breeder 2.0 is a R/Shiny application for statistical analysis and plant breeding developed by Dr. 
# Roberto Fritsche Neto and Ph.D. students Filipe Inacio Matias and Julia Silva Morosini, 
# who integrate the Laboratory of Allogamous Plant Breeding group - Department of Genetics, 
# 'Luiz de Queiroz' College of Agriculture, University of Sao Paulo, Brazil."
      ...
      tabItem("info2",
              fluidPage(
                titlePanel("Citation"),
                br(),
"1. Fritsche-Neto, Roberto, & Matias, Filipe Inácio. (2016). Be-Breeder - Learning: a new tool for teaching and learning plant breeding principles. 
Crop Breeding and Applied Biotechnology, 16(3), 240-245",
a(href="https://dx.doi.org/10.1590/1984-70332016v16n3n36", "https://dx.doi.org/10.1590/1984-70332016v16n3n36"),
      h1(),
...
a(href="https://dx.doi.org/10.1590/1984-70332017v17n1n8", "https://dx.doi.org/10.1590/1984-70332017v17n1n8")
    )),
...
# #####################################################################################################################################################################################
      ...
      output$cont.Lear.1.0 <- renderTable(rownames = T, bordered = T, colnames = T, align = "l", digits = 3,{
        f.1<-input$Lear1.2
        a1<-2*f.1 # Va. Among
        a2<-(1-f.1) # Va. Within
...
# #####################################################################################################################################################################################
      ...
      output$cont.Lear.4 <- renderTable(rownames = T, colnames = F,{
...
# #####################################################################################################################################################################################
      ...
      output$cont.Lear.5.0 <- renderTable(rownames = T, colnames = T, align = "c",{
        LIS.0<-as.data.frame(cont.Lear.5()[[1]], row.names = "")
        return(LIS.0)})
        
      output$cont.Lear.5.1 <- renderTable(rownames = T, colnames = T, align = "l",{
        LIS.1<-as.data.frame(cont.Lear.5()[[2]], row.names = c("AA", "Aa", "aa", "Total"))
        return(LIS.1)})
      
      output$cont.Lear.5.2 <- renderTable(rownames = T, colnames = T, align = "c",{
        LIS.2<-as.data.frame(cont.Lear.5()[[3]], row.names = "")
        return(LIS.2)})
        
      output$cont.Lear.5.3 <- renderTable(rownames = T, colnames = T, align = "c",{
        LIS.3<-as.data.frame(cont.Lear.5()[[6]], row.names = "")
        return(LIS.3)})
        
      output$cont.Lear.5.4 <- renderTable(rownames = T, colnames = T, align = "c",{
        LIS.4<-as.data.frame(cont.Lear.5()[[4]], row.names = "")
        return(LIS.4)})
      
      output$cont.Lear.5.5 <- renderTable(rownames = T, colnames = T, align = "l",{
...
# #####################################################################################################################################################################################
      ...
      output$cont.Lear.6.1 <- renderTable(rownames = T, colnames = T,{
        d<-input$Lear6.1
        p<-input$Lear6.2
        a<-input$Lear6.3
        #sigmaSq = '\u03c3\u00B2'
...
# #####################################################################################################################################################################################
      ...
      output$cont.Lear.7 <- renderTable(rownames = F, colnames = T, align = "c",{
        prog<-input$Lear7.1
        ...
        if(sum(allel.0)!=1)
        {return(paste("The sum of frequencies should be equal a 1"))}
        allel<-allel.0
        div<-(sum(allel^2))
        RH<-1-div
        Var.G<-div-div^2
...
# #####################################################################################################################################################################################
     ...
     output$cont.Lear.8a1 <- renderTable(rownames = T, colnames = T, align = "c",{
       GS<-as.data.frame(cont.Lear.8a()[[1]], row.names = "")
       return(GS)})
...
# #####################################################################################################################################################################################
      ...
      out.Lear.92.One<-reactive({
        ...
        colnames(HIB)<-c("Number of Lines","|  SH","|  TH","|  DH")
        return(HIB)})
      out.Lear.92.Two<-reactive({
        ...
        colnames(HIB)<-c("Lines Group A","|  Lines Group B","|  SH","|  TH","|  DH")
        return(HIB)})
